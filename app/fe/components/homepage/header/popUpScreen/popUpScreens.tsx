...
const PopupScreen = () => {
    ...
    return (
        <div>
            {isPopupVisible && (
            <div className="w-[700px] h-[200px] inline-block bg-white mt-40 border border-solid border-black rounded-lg shadow-lg">
                ...
                <div className="flex flex-row items-center flex-1">
                    ...
                    <div className="flex-1">
                        <div className="flex justify-center mt-16">
                            <p className="text-slate-800 text-sm font-bold">Rạp</p>
                        </div>
                        <div className="flex justify-center">
                            <select
                                id='rap'
